window.onload = function () {
    tinymce.init({
        ...
        toolbar:
            'bold italic underline | alignleft aligncenter alignright alignjustify | bulist numlist | outdent indent | link image media | forecolor backcolor emoticons | code preview searchreplace',
